  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 flex-1 max-w-xl">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-[#262626] border border-[#404040] rounded-3xl text-sm text-[#FAFAFA] placeholder:text-[#A3A3A3] focus:outline-none focus:ring-2 focus:ring-[#FFB380] focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Autopilot Toggle */}
        <div className="flex items-center gap-3 px-3 py-2 bg-[#262626] rounded-3xl border border-[#404040]">
        ...
        {/* Notifications */}
        <button className="relative p-2 hover:bg-[#262626] rounded-3xl transition-colors">
          <Bell size={20} className="text-[#A3A3A3]" />
          <span className="absolute top-1 right-1 w-2 h-2 bg-[#FFB380] rounded-full" />
        </button>

        {/* Profile */}
        <button className="flex items-center gap-2 p-1.5 hover:bg-[#262626] rounded-3xl transition-colors">
